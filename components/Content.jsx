...
function Content() {
    return (
        <div>
            ...
            {/* Enroll now button  */}
            <button className='absolute top-[1756px] left-[118px] pt-[8px] px-[18px] pb-[7px] font-PSANS font-[700] text-[14px] leading-[17px] text-[#5F72BE] box-border border-[1.8px] border-solid border-[#5F72BE] rounded-[100px] hover:text-[#fff] hover:bg-[#5F72BE] transition ease-in duration-300  '>ENROLL NOW</button>
            ...
            <div className='absolute w-[200px] h-[200px] top-[1348px] left-[778px] rounded-full bg-[#fff7eb] cursor-pointer ' >
            ...
            <div className='absolute w-[200px] h-[200px] top-[1460px] left-[1122px] rounded-full bg-[#fdeeee] cursor-pointer ' >
            ...
            <div className='absolute w-[200px] h-[200px] top-[1612px] left-[778px] rounded-full bg-[#eaf2fe] cursor-pointer ' >
            ...
            <div className='absolute w-[200px] h-[200px] top-[1724px] left-[1122px] rounded-full bg-[#e6f8f2] cursor-pointer ' >
            ...
            <p className='w-[52px] h-[38px] absolute top-[1957px] left-[701px] font-PSANS font-[700] text-[16px] leading-[19px] text-[#FE5702] '>100 K+
                Views</p>
            <div className='absolute w-[200px] h-[200px] top-[1876px] left-[781px] rounded-full bg-[#ffeee6] cursor-pointer ' >
            ...
            <div className='absolute top-[2514.75px] right-[114.57px] cursor-pointer '><Image src={rightarrow} alt=''/></div>
            <div className='absolute top-[2514.75px] left-[129.07px] cursor-pointer '><Image src={leftarrow} alt=''/></div>
