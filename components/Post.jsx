...
function Post({ img, title, username, rating }) {
  return (
    <div className='w-[282px] h-[312px] bg-[#ffffff] rounded-[12px] shadow-my-shadow mr-[32px] '>
        ...
        {/* fav icon  */}
        <div className='absolute top-[154px] left-[252px] '><Image src={favorite} alt=''/></div>
        ...
        {/* Enroll now button  */}
        <button className='absolute top-[262px] left-[27px] pt-[8px] px-[18px] pb-[7px] font-PSANS font-[700] text-[14px] leading-[17px] text-[#5F72BE] box-border border-[1.8px] border-solid border-[#5F72BE] rounded-[100px] '>ENROLL NOW</button>
